...
export const metadata = {
  ...
  description: "Découvrez l'histoire inspirante de MySelfe Groupe, une entreprise familiale passionnée par l'entrepreneuriat et la création de marques uniques. Explorez notre parcours, nos valeurs et nos entreprises, notamment Namas'Thés, une marque de thés d'exception. Rejoignez-nous dans cette aventure entrepreneuriale et découvrez comment nous transformons nos passions en succès.",
};
  ...
  return (
    <div className="flex flex-col bg-background text-foreground">
      <section id="accueil" className="min-h-screen flex items-start">
        <main className="mx-auto w-full max-w-5xl px-6 py-20 sm:px-10 lg:px-6">
          <div className="flex flex-row items-center justify-center gap-12">
            ...
            <Image
              ...
              width={700}
              height={700}
              className="aspect-square w-1/3 rounded-full object-cover border-secondary border shadow-lg z-10"
            />
            <div className="max-w-2xl space-y-6 z-10">
              <p className="text-sm font-medium uppercase tracking-[0.35em] text-secondary">
                Histoire
              </p>
              <h1 className="font-title text-4xl font tracking-wide text-foreground sm:text-5xl">
                Le parcours de Myselfe Groupe, une aventure entrepreneuriale inspirante
              </h1>
              <p className="max-w-xl text-md leading-7 text-secondary">
        ...
        <div className="relative flex flex-row mx-auto w-full max-w-6xl gap-8 px-6 sm:px-10 lg:px-12">
          <div className="space-y-6">
            ...
            <div className="flex flex-row gap-4">
              <div className="w-2/3 space-y-6 rounded-2xl border border-border bg-white/60 p-8 shadow-[0_20px_80px_rgba(31,43,91,0.08)] backdrop-blur-sm sm:p-10">
